...
class MiniloColors {
  ...
  static const MiniloColors light = MiniloColors(
    ...
    surfaceMuted: Color(0xFFF5F4F4),
    border: Color(0xFFB1B4B6),
    primary: Color(0xFF003078),
    primaryStrong: Color(0xFF003078),
    secondary: Color(0xFF1D70B8),
    secondarySoft: Color(0xFFE8F1F8),
    text: Color(0xFF191D23),
    textMuted: Color(0xFF383F43),
    textInverse: Color(0xFFF8FAFC),
    success: Color(0xFF005A30),
    successSoft: Color(0xFFE6EFEA),
    alert: Color(0xFFD4351C),
    alertSoft: Color(0xFFFBEBE8),
    warning: Color(0xFFF89707),
    warningSoft: Color(0xFFFFFCE6),
  );
